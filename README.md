...
Menus as defined in Bootstrap: http://getbootstrap.com/components/#navbar
...
```html
<!-- Includes all menu elements -->
<link rel="import" href="libs/bs-menu/bs-menu.html">
...
To generate this Bootstrap code (from BS doc):
...
`http://localhost:8080/components/bs-menu/`, where `bs-menu` is the name of the directory containing it.


## Test

Simply navigate to the `/test` directory of your element to run its tests. If
you are using Polyserve: `http://localhost:8080/components/bs-menu/test/`
